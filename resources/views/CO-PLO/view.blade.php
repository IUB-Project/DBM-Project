      ...
      <div class="row">
        <div class="col">
          <div class="card">
            ...
            <!-- Light table -->
            <form action = "/enrollmentview" method = "post" style="padding-left:25px; padding-right:25px;">
                   ...
                   <tr>
                    <div class="form-group mb-0" style="width: 350px">
                        <div class="input-group input-group-alternative input-group-merge">
                          ...
                          <input type="text" name="degreeProgram_id" class="form-control" placeholder="Degree Program" >
                        </div>
                      </div>
