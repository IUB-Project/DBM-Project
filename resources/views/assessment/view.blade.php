        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">View Assessment Data</h3>
            </div>
            <!-- Light table -->
            <form action = "/assessmentview" method = "post" style="padding-left:25px; padding-right:25px;">
     ...
     @if(empty($results))
        @else
            ...
            <table class="table align-items-center">
                ...
                <tr>
                <td>{{ $r->assessmentType }} {{ $r->assessmentNo }}</td>
                <td>{{ $r->questionNo }}</td>
                <td>{{ $r->achievedMark }}</td>
                </tr>
                @endforeach
            </thead>
                </table>
